...
Scenario Product Name And Product Code Search
-------------------------------------------------
tags:Gratis_Android_BasariliBasarisizUrunAramaVeUrunKoduArama
* Uygulama baslatilir.
...
Scenario Category And Trademark Search
------------------------------------------
tags:Gratis_Android_KategoriVeMarkaArama
* Uygulama baslatilir.
* Search ikonuna tiklanir.
* Arama sayfasinin acildigi gorulur.
...
----------------------------------------------------------
tags:Gratis_Android_PopulerKategoriVePopulerMarkaArama
* Uygulama baslatilir.
* Search ikonuna tiklanir.
* Arama sayfasinin acildigi gorulur.
